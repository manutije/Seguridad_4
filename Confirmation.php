...
if(isset($_POST['pricecheck']) or isset($_POST['continue'])){
	...
	$amount=mysql_num_rows($result);
		...
		elseif(isset($_POST['continue'])){
            ...
            <style>
            #tblabel{color:#FF0000; font-family:'TYPOGRAPHPRO-Light';src: url(Content/TYPOGRAPHPRO-Light.ttf); text-shadow:0px 0px 10px rgba(255,0,0,0); text-transform:uppercase; }
			.td_a{font-size:18px}
			.td_b{font-size:18px}
			.td_c{font-size:18px}
			.td_d{font-size:12px}
