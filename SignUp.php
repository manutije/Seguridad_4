...
a:link {color: rgba(255, 5, 0, 0.8);text-decoration: none;}
a:visited {color: rgba(255, 5, 2, 0.8);text-decoration: none;}
a:hover {color: #F69;text-decoration: none;}
a:active {color: #F36;text-decoration: none;}

#b_fn {color:#<?PHP if(isset($_GET['ve'])){echo $fnc;}else{echo"FF6F00";} ?>; text-transform:uppercase;font-size: 13px;}
#b_ln {color:#<?PHP if(isset($_GET['ve'])){echo $lnc;}else{echo"FF6F00";} ?>; text-transform:uppercase;font-size: 13px;}
#b_ea {color:#<?PHP if(isset($_GET['ve'])){echo $eac;}else{echo"FF6F00";} ?>; text-transform:uppercase;font-size: 13px;}
#b_ap {color:#<?PHP if(isset($_GET['ve'])){echo $apc;}else{echo"FF6F00";} ?>; text-transform:uppercase;font-size: 13px;}
#b_cn {color:#<?PHP if(isset($_GET['ve'])){echo $cnc;}else{echo"FF6F00";} ?>; text-transform:uppercase;font-size: 13px;}
#b_ce {color:#<?PHP if(isset($_GET['ve'])){echo $cec;}else{echo"FF6F00";} ?>; text-transform:uppercase;font-size: 13px;}
